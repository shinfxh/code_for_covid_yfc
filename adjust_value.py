...
infected[first_infection]=incubation + 1;
...
while run:
    ...
    but_qua_text = pygame_gui.elements.UIButton(relative_rect = pygame.Rect((440-222, 440-39), (219, 35)), text= 'Quarantined:' , manager = manager)
    element_list.append(but_qua_text)
    but_death_text = pygame_gui.elements.UIButton(relative_rect = pygame.Rect((65, 440-39), (159, 35)), text = 'Dead:' + str(n_init-n), manager = manager)
